...
import static com.msl.mslapp.RTUMainActivity.DATA_NUM_4;
...
public class dialogFragment_rtu_Setting_Protocol_Change extends DialogFragment {
    ...
    void btn_Setting() {
        ...
        btn_On.setOnClickListener(v -> {
            Toast.makeText(mContext, getString(R.string.RTU_protocol_private), Toast.LENGTH_SHORT).show();
        ...
        btn_Off.setOnClickListener(v -> {
            Toast.makeText(mContext, getString(R.string.RTU_protocol_standard), Toast.LENGTH_SHORT).show();
            String data = DATA_SIGN_START + DATA_TYPE_MUCMD + DATA_SIGN_COMMA +
                    DATA_NUM_4 + DATA_SIGN_COMMA +
