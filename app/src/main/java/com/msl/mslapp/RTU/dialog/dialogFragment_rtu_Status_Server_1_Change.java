...
import static com.msl.mslapp.RTU.fragment.fragment_RTU_Status.Server_2;
import static com.msl.mslapp.RTU.fragment.fragment_RTU_Status.Server_Port_2;
...
public class dialogFragment_rtu_Status_Server_1_Change extends DialogFragment {

    // 로그 이름 용
    public static final String TAG = "Msl-RTU-Status-Dialog-Server_1_Change";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        Log.d(TAG, "dialogFragment_rtu_Status_Server_1_Change onCreateView");
    ...
    void btn_Setting() {
        ...
        btn_confirm.setOnClickListener(v -> {
            if (tv_port_5.getText().toString().equals("")) {
                ...
                String Server_1_data = tv_server_1.getText().toString() + tv_server_2.getText().toString() + tv_server_3.getText().toString() + DATA_SIGN_COMMA +
                ...
                String Server_Port_1_data = tv_port_1.getText().toString() + tv_port_2.getText().toString() + tv_port_3.getText().toString() +
                ...
                if(from.equals("ble")){
                    ...
                    String data = DATA_SIGN_START + DATA_TYPE_MUCMD + DATA_SIGN_COMMA +
                            ...
                            Server_1_data + DATA_SIGN_COMMA +
                            Server_Port_1_data + DATA_SIGN_COMMA +
                            mArgs.getString("server2") + DATA_SIGN_COMMA +
                            mArgs.getString("server2port") + DATA_SIGN_CHECKSUM +
                    ...
                    String data = DATA_SIGN_START + DATA_TYPE_MUCMD + DATA_SIGN_COMMA +
                            ...
                            Server_1_data + DATA_SIGN_COMMA +
                            Server_Port_1_data + DATA_SIGN_COMMA +
                            Server_2 + DATA_SIGN_COMMA +
                            Server_Port_2 + DATA_SIGN_CHECKSUM +
                            DATA_NUM_1 + DATA_NUM_1 +
                            DATA_SIGN_CR + DATA_SIGN_LF;
