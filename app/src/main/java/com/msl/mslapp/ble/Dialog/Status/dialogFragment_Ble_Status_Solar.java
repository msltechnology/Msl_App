...
import com.msl.mslapp.databinding.BleFragmentStatusDialogSolarBinding;
...
public class dialogFragment_Ble_Status_Solar extends DialogFragment {
    ...
    BleFragmentStatusDialogSolarBinding bleFragmentStatusDialogSolarBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bleFragmentStatusDialogSolarBinding = DataBindingUtil.inflate(inflater,R.layout.ble_fragment_status_dialog_solar,container, false);

        view = bleFragmentStatusDialogSolarBinding.getRoot();


        bleViewModel = new ViewModelProvider(requireActivity()).get(BleViewModel.class);
        bleFragmentStatusDialogSolarBinding.setBleViewModel(bleViewModel);
        bleFragmentStatusDialogSolarBinding.setLifecycleOwner(getViewLifecycleOwner());
