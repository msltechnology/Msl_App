...
public class dialogFragment_Ble_Status_Battery extends DialogFragment {
    ...
    BleFragmentStatusDialogBatteryBinding bleFragmentStatusDialogBatteryBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bleFragmentStatusDialogBatteryBinding = DataBindingUtil.inflate(inflater,R.layout.ble_fragment_status_dialog_battery,container, false);

        view = bleFragmentStatusDialogBatteryBinding.getRoot();


        bleViewModel = new ViewModelProvider(requireActivity()).get(BleViewModel.class);
        bleFragmentStatusDialogBatteryBinding.setBleViewModel(bleViewModel);
        bleFragmentStatusDialogBatteryBinding.setLifecycleOwner(getViewLifecycleOwner());
